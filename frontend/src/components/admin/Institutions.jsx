...
export default function Institutions() {
  ...
  const fetchInstitutions = async () => {
    try {
      const res = await fetch("https://careerplatform-xu14.onrender.com/admin/institutions");
  ...
  const addInstitution = async () => {
    try {
      const res = await fetch("https://careerplatform-xu14.onrender.com/admin/institutes", {
        method: "POST",
  ...
  const deleteInstitution = async (id) => {
    try {
      const res = await fetch(`https://careerplatform-xu14.onrender.com/admin/institutes/${id}`, {
        method: "DELETE",
      });
      const data = await res.json();
