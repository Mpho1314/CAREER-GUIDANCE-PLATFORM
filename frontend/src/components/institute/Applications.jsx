...
const Applications = ({ user }) => {
    ...
    const fetchApplications = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://careerplatform-o67g.onrender.com/institute/${user.institutionId}/applications`
        );
  ...
  const updateStatus = async (appId, newStatus) => {
    try {
      ...
      const res = await fetch(
        `https://careerplatform-o67g.onrender.com/institute/${user.institutionId}/admissions/${appId}`,
        {
          method: "PATCH",
